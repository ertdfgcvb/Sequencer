...
var Sequencer = (function(){	
	...
	function loadNext(){
		...
		if (num <= config.to) {		 
			...
			img.onload = function(){
				...
				div.style.backgroundSize = config.scaleMode;
	...
	function showImage(id){
		if (actual >= 0 && actual < imgList.length && actual != id){
			imgList[actual].style.visibility = "hidden";
		}
		if (actual != id) {
			imgList[id].style.visibility = "visible";
			actual = id;
		}
	}
